...
public class UpdateRoomOperationProcessor extends BaseOperationProcessor implements UpdateRoomOperation {
    ...
    public UpdateRoomOperationProcessor(Validator validator, ErrorHandler errorHandler, RoomRepository roomRepository, BedRepository bedRepository) {
    ...
    public Either<ErrorWrapper, UpdateRoomOutput> process(UpdateRoomInput input) {
        ...
        return validateInput(input).flatMap(validatedInput ->
                Try.of(() -> {
                            ...
                            log.info("Room entity,{}", updateEntity);
